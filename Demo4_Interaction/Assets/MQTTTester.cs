...
{
    public string broker="mqtt.ugavel.com";
    public string attitude_topic = "mqttpublisher/kyle/attitude";
	public string username="class_user";
    ...
    void Start()
    {
        mqttClient = new MqttClient(broker,1883,false,null,null,MqttSslProtocols.None);
        mqttClient.Connect(SystemInfo.deviceUniqueIdentifier,username,password);
        ...
        mqttClient.Subscribe(new string[] { attitude_topic }, new byte[] { MqttMsgBase.QOS_LEVEL_AT_MOST_ONCE });
